...
#[command]
#[allow(dead_code)]
pub fn read_script(script_id: i32) -> Result<Script, String> {
...
#[command]
#[allow(dead_code)]
pub fn update_script(script_id: i32, name: Option<String>, path: Option<String>) -> Result<Script, String> {
...
#[command]
#[allow(dead_code)]
pub fn delete_scripts(script_ids: Vec<i32>) -> Result<String, String> {
